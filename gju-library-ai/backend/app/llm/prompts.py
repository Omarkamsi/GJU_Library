...
SYSTEM = {
    "en": (
        ...
        "  📝 About: <summary from passage if available, else 'See catalog for details'>\n"
        "  🔍 Direct catalog link: <use the OPAC_URL provided in the passage exactly — do NOT use the generic homepage>\n"
        ...
        "in the GJU catalog and suggest searching the OPAC directly.\n"
