...
// Inject ripple keyframes once on the client
if (typeof document !== "undefined" && !document.getElementById("ripple-kf")) {
    const style = document.createElement("style");
    style.id = "ripple-kf";
    style.textContent =
        "@keyframes ripple{0%{transform:scale(0.5);opacity:0.6}100%{transform:scale(2);opacity:0}}";
